...
/* DAY-3 : Assignment 3: Student Marks List
...
let highestMark = marks.reduce((high,mark) => (high > mark)? high : mark) /* checks if the first element
is higher than the next element and updates high*/
